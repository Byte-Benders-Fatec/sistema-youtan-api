...
export class AddUserHasAnswered1731007652162 implements MigrationInterface {
    name = 'AddUserHasAnswered1731007652162'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`answers\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userAnswers\` text NULL, \`userHasAnswered\` tinyint NOT NULL DEFAULT 0, \`userId\` int NULL, \`formId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
