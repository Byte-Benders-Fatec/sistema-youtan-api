...
export class TestAnswersModel1730900483979 implements MigrationInterface {
    name = 'TestAnswersModel1730900483979'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`answers\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userAnswers\` text NULL, \`userId\` int NULL, \`formId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
